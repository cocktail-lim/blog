        ...
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/myblog?useUnicode=true&characterEncoding=utf-8&userSSL=false&serverTimezone=GMT%2B8",
                ...
                .globalConfig(builder -> {
                    builder.author("finn") // 设置作者
                            ...
                            .outputDir("E:\\myblog\\myblog\\" + moduleName + "\\src\\main\\java"); // 指定输出目录
                })
...
//                            .moduleName("blog_web") // 设置父包模块名
                            ...
                            .mapper("mapper")
                            .xml("mapper")
                            .pathInfo(Collections.singletonMap(OutputFile.mapperXml, "E:\\myblog\\myblog\\" + moduleName + "\\src\\main\\resources")); // 设置mapperXml生成路径
                })
                .strategyConfig(builder -> {
                    builder.addInclude("tb_user") // 设置需要生成的表名
                            .addTablePrefix("tb_", "c_"); // 设置过滤表前缀，生成的entity等名字过滤前缀
                })
                .strategyConfig(builder -> {
